...
# app.config['SQLALCHEMY_DATABASE_URI'] = "postgresql://localhost:5432/myevent5"
...
# Linking and registering event_posts views Blueprint
from myapp.event_posts.views import event_posts
